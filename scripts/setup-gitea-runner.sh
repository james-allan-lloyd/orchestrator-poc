...
echo "Using instance URL: $LOCAL_GITEA_URL"
...
docker run -d \
  ...
  -e GITEA_INSTANCE_URL="$LOCAL_GITEA_URL" \
...
echo "  Instance URL: $LOCAL_GITEA_URL"
...
echo ""
echo "ℹ️  Note: Keep the port forward running (PID: $PORT_FORWARD_PID) for the runner to work"
