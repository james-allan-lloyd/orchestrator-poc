...
def main():
    ...
    team_name = team_resource.get_value("metadata.name")
    team_id = team_resource.get_value("spec.id")
    team_display_name = team_resource.get_value("spec.name")
    ...
    yaml_content = yaml.dump(backstage_team, default_flow_style=False)
